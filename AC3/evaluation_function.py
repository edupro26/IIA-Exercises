...
chapiteau = JogadorAlfaBeta("chapiteau", 4, chapiteau_replica)
jogador_26 = JogadorAlfaBeta("jogador_26", 4, func_26)

win_rates = []
jogo=Kalah(0)
for i in range(3):
    _, _, res, p = jogaNpares(jogo, 100, chapiteau, jogador_26)
    print("Games:", res)
    print("Points:", p)
    print("----------------------------------------------------------")
    win_rates.append(res["jogador_26"] / res["chapiteau"])
